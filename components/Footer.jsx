            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <div className="relative w-32">
                  <Link href="/" className="inline-block w-full text-xl">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-body-color dark:text-dark-6 text-base">
                  &copy; {new Date().getFullYear()} Wow Invites
                </p>
              </div>
            </div>
          </div>
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="text-body-color dark:text-dark-6 inline-block text-base leading-loose transition-colors hover:text-white/50"
      >
        {label}
      </a>
    </li>
